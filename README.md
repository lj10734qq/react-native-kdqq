# react-native-kdqq
[![npm version](https://badge.fury.io/js/react-native-kdqq.svg?style=flat)](https://badge.fury.io/js/react-native-kdqq)
[![platform](https://img.shields.io/badge/platform-iOS%2FAndroid-lightgrey.svg?style=flat)](https://github.com/iVanPan/react-native-kdqq)
[![GitHub license](https://img.shields.io/github/license/mashape/apistatus.svg?style=flat)](https://github.com/iVanPan/react-native-kdqq/blob/master/LICENSE)
...
##Installation
```shell
npm install --save react-native-kdqq@latest
```
###RNPM
```
 react-native link react-native-kdqq
```
###Manual
```shell
npm install --save react-native-kdqq@latest
...
2. Find the `RCTQQSDK.xcodeproj` file within the `node_modules/react-native-kdqq/ios` directory  and drag it into the `Libraries` node in Xcode
...
6. Click the plus sign underneath the "Link Binary With Libraries" list and add the TencentOpenAPI.framework which locate in `../node_modules/react-native-kdqq/ios/RCTQQSDK`. Then Under the "Build Settings" tab of your project configuration, find the "Framework Search Paths" section and edit the value. Add a new value, `$(SRCROOT)/../node_modules/react-native-kdqq/ios/RCTQQSDK`.
...
8. Under the "Info" tab of your project configuration, add LSApplicationQueriesSchemes For QQ SDK.
  ![Add LSApplicationQueriesSchemes](https://github.com/iVanPan/react-native-kdqq/blob/master/asset/%E5%B1%8F%E5%B9%95%E5%BF%AB%E7%85%A7%202016-12-13%2013.47.15.png)
...
1. In your `android/settings.gradle` file, make the following additions:
    ...
    ```gradle
    include ':app', ':react-native-kdqq'
    project(':react-native-kdqq').projectDir = new File(rootProject.projectDir, '../node_modules/react-native-kdqq/android')
    ```

2. In your `android/app/build.gradle` file, add the `:react-native-kdqq` project as a compile-time dependency:

    ```gradle
    ...
    dependencies {
        ...
        compile project(':react-native-kdqq')
    }
    ```
3. add App ID to `android/app/build.gradle` which locate in react-native-kdqq node_modules folder
  ...
  manifestPlaceholders = [
    ...
    ```
4.Update the `MainApplication.java` file to use react-native-kdqq via the following changes:
...
#####checkClientInstalled
  ```js
import * as QQ from "react-native-kdqq";
...
**react-native-kdqq** is released under the **MIT** license. See [LICENSE](https://github.com/iVanPan/react-native-kdqq/blob/master/LICENSE) file for more information.
